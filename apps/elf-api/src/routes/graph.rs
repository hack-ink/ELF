...
pub(super) async fn graph_query(
...
pub(super) async fn graph_report(
	State(state): State<AppState>,
	headers: HeaderMap,
...
pub(super) async fn admin_graph_predicates_list(
	State(state): State<AppState>,
	headers: HeaderMap,
...
pub(super) async fn admin_graph_predicate_patch(
	State(state): State<AppState>,
	headers: HeaderMap,
...
pub(super) async fn admin_graph_predicate_alias_add(
	State(state): State<AppState>,
	headers: HeaderMap,
	Path(predicate_id): Path<Uuid>,
...
pub(super) async fn admin_graph_predicate_aliases_list(
	State(state): State<AppState>,
	headers: HeaderMap,
	Path(predicate_id): Path<Uuid>,
) -> Result<Json<AdminGraphPredicateAliasesResponse>, ApiError> {
