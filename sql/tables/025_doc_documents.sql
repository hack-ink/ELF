...
ALTER TABLE doc_documents
	ADD COLUMN IF NOT EXISTS doc_type text NOT NULL DEFAULT 'knowledge';
...
ALTER TABLE doc_documents
	DROP CONSTRAINT IF EXISTS ck_doc_documents_doc_type;
ALTER TABLE doc_documents
	ADD CONSTRAINT ck_doc_documents_doc_type
		CHECK (doc_type IN ('knowledge', 'chat', 'search', 'dev'));
