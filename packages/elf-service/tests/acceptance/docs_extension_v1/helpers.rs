...
pub(crate) const DOCS_SEARCH_FILTER_INDEXES: [(&str, PayloadSchemaType, FieldType); 9] = [
...
#[derive(FromRow)]
pub(crate) struct DocOutboxCounts {
	total: i64,
	done: i64,
	failed: i64,
}
...
#[derive(FromRow)]
pub(crate) struct NoteOutboxCounts {
	total: i64,
	done: i64,
	failed: i64,
}
...
pub(crate) fn build_test_tokenizer() -> Tokenizer {
...
pub(crate) async fn start_embed_server() -> (String, Sender<()>) {
...
pub(crate) async fn embed_handler(
	State(()): State<()>,
