...
pub(in crate::acceptance::english_only_boundary) struct BoundaryFixture {
	pub(in crate::acceptance::english_only_boundary) service: ElfService,
	pub(in crate::acceptance::english_only_boundary) test_db: TestDatabase,
}

pub(in crate::acceptance::english_only_boundary) async fn setup_service(
	test_name: &str,
