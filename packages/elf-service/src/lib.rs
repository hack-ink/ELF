...
pub use self::{
	...
	knowledge::{
		...
		KnowledgePageLintResponse, KnowledgePageLintSummary, KnowledgePageRebuildRequest,
		KnowledgePageRebuildResponse, KnowledgePageResponse, KnowledgePageSearchItem,
		KnowledgePageSearchRequest, KnowledgePageSearchResponse, KnowledgePageSectionResponse,
