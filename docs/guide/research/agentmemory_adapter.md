...
and retrieval cases.
Depends on: `elf-eval`, `docs/research/2026-06-08-agent-memory-selection.json`,
...
For config-to-config comparisons or trace replay, follow `docs/guide/evaluation.md`.
