---
type: Reference
title: "Search Modes: `quick_find` vs `planned_search` (Design)"
description: "Retained historical plan artifact: Search Modes: `quick_find` vs `planned_search` (Design)."
resource: docs/reference/plans/2026-03-04-search-modes-design.md
status: active
