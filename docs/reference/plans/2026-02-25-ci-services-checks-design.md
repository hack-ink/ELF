---
type: Reference
title: "CI Service-Backed Checks Design"
description: "Retained historical plan artifact: CI Service-Backed Checks Design."
resource: docs/reference/plans/2026-02-25-ci-services-checks-design.md
status: active
...
- `docs/runbook/integration-testing.md`
- `docs/runbook/testing.md`
