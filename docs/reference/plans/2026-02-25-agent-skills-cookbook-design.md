---
type: Reference
title: "Agent Skills Cookbook (MCP-first) — Design"
description: "Retained historical plan artifact: Agent Skills Cookbook (MCP-first) — Design."
resource: docs/reference/plans/2026-02-25-agent-skills-cookbook-design.md
status: active
...
This cookbook is a runbook/playbook, not a system contract. It must not change ELF Core semantics.
