---
type: Reference
title: "Agent Memory (MCP + Skills) Backlog"
description: "Retained historical plan artifact: Agent Memory (MCP + Skills) Backlog."
resource: docs/reference/plans/2026-02-23-agent-memory-mcp-skills-backlog.md
status: active
...
Acceptance criteria:
- Add a spec/runbook page describing the schema and forward/backward compatibility rules.
