---
type: Reference
title: "Org-Shared (Tenant-Wide) Semantics Implementation Plan"
description: "Retained historical plan artifact: Org-Shared (Tenant-Wide) Semantics Implementation Plan."
resource: docs/reference/plans/2026-02-22-org-shared-implementation-plan.md
status: active
...
Plan complete and saved to `docs/reference/plans/2026-02-22-org-shared-implementation-plan.md`.
