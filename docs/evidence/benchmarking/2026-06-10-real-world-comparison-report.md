---
type: Evidence
title: "Real-World Comparison Report - June 10, 2026"
description: "Checked-in benchmark evidence record: Real-World Comparison Report - June 10, 2026."
resource: docs/evidence/benchmarking/2026-06-10-real-world-comparison-report.md
status: active
...
and the live-baseline reports linked from this evidence record.
...
`docs/runbook/benchmarking/live_baseline_benchmark.md`.
...
`docs/evidence/benchmarking/2026-06-10-live-real-world-sweep-report.md`: ELF and qmd now
