---
type: Evidence
title: "First-Generation OSS Adapter Promotion Report - June 11, 2026"
description: "Checked-in benchmark evidence record: First-Generation OSS Adapter Promotion Report - June 11, 2026."
resource: docs/evidence/benchmarking/2026-06-11-first-generation-oss-adapter-promotion-report.md
status: active
...
| --- | --- | ---: | --- |
| `ELF_BASELINE_PROJECTS=ELF,agentmemory,mem0,memsearch,claude-mem cargo make baseline-live-docker` | fail with typed non-pass projects | 295.74 seconds | `tmp/live-baseline/live-baseline-report.json` |
