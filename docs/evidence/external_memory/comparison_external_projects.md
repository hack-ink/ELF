---
type: Evidence
title: "External Memory Project Comparison"
description: "Provide a detailed, evidence-backed comparison between ELF and adjacent memory projects."
resource: docs/evidence/external_memory/comparison_external_projects.md
status: active
...
Depends on: `docs/spec/system_elf_memory_service_v2.md` and `docs/evidence/external_memory/research_projects_inventory.md`.
...
For a full list of reviewed and pending projects, see `docs/evidence/external_memory/research_projects_inventory.md`.
