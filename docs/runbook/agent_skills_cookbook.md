---
type: Runbook
title: "Agent Skills Cookbook (MCP-first)"
description: "Provide reference agent-side workflows for using ELF via MCP in a consistent, auditable, facts-first way."
resource: docs/runbook/agent_skills_cookbook.md
status: active
...
Scope: This is a runbook/playbook. It is non-normative and does not change the ELF system contract.
