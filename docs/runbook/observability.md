---
type: Runbook
title: "Observability and Correlation (MCP + Admin API)"
description: "Provide a practical traceability workflow for agents and operators."
resource: docs/runbook/observability.md
status: active
