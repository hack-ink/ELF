---
type: Runbook
title: "External Memory Pattern Radar"
description: "Runbook for the weekly external memory pattern radar workflow."
resource: docs/runbook/external_memory_pattern_radar.md
status: active
...
Inputs: `apps/elf-eval/fixtures/external_memory_pattern_radar/cursor.json`, GitHub repository
...
`docs/evidence/external_memory/comparison_external_projects.md`, and
`docs/evidence/external_memory/research_projects_inventory.md`.
Outputs: Updated cursor JSON plus `docs/evidence/external_memory_pattern_radar_latest.md`.
